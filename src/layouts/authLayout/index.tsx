...
const AuthLayout: React.FC = () => {
  return (
    <Container>
      <FormContainer zindex={100} left={'calc(100% - 600px )'}>
        <Form id="a-form" method="" action="">
          ...
          <FormButton className="form__button button submit">
            SIGN UP
          </FormButton>
        </Form>
      </FormContainer>
      <FormContainer zindex={0} left={'calc(100% - 600px )'}>
        <Form id="b-form" method="" action="">
      ...
      <SwitchContainer id="switch-cnt">
        <SwitchCircle className="switch__circle"></SwitchCircle>
        <SwitchCircleT></SwitchCircleT>
        <SwitchContent id="switch-c1" ishidden={false}>
        ...
        <SwitchContent id="switch-c2" ishidden={true}>
...
const FormIcon = styled.img`
  ${tw`object-contain w-8 mx-1 opacity-50`}
...
const FormInput = styled.input`
  ${tw`w-[350px] h-10 my-1 pl-6 text-[13px] tracking-[.15px] border-none outline-none bg-[#ecf0f3] rounded-lg`}
...
const FormLink = styled.a`
  ${tw`text-[#181818] text-[15px] mt-6 leading-loose`}

  border-bottom: 1px solid #a0a5a8;
`

const FormTitle = styled.h2`
  ${tw`text-[34px] font-bold leading-[3] text-[#181818]`}
`

const Description = styled.p`
  ${tw`text-[14px] tracking-[.25px] text-center leading-[1.6]`}
`
...
`
const SwitchCircleT = styled.div`
...
const SwitchContent = styled.div<SwitchContentProps>`
